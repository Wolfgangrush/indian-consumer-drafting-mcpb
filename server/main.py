"""wolfgang_rush — Indian Consumer Forum Drafting MCPB.

Local-execution MCPB Desktop Extension for the Consumer Protection Act 2019
forum architecture (District / State / NCDRC).

Privacy: zero data collection.
License: MIT
Source: https://github.com/Wolfgangrush/indian-consumer-drafting-mcpb
...
mcp = FastMCP("wolfgang-indian-consumer-drafting")

BUNDLE_ROOT = Path(__file__).resolve().parent.parent
SKILLS_DIR = BUNDLE_ROOT / "skills"
AGENTS_DIR = BUNDLE_ROOT / "agents"
PLEADING_BASE_DIR = SKILLS_DIR / "_consumer_drafting_base"

CASE_TYPES: list[str] = [
    "district-commission-complaint-section-35",
    "state-commission-complaint-section-47",
    "ncdrc-complaint-section-58",
    "medical-negligence-complaint",
    "product-liability-action-section-83",
    "unfair-trade-practice-complaint",
    "consumer-appeal-section-41-district-to-state",
    "consumer-appeal-section-51-state-to-ncdrc",
    "consumer-revisional-application-section-67",
    "consumer-execution-application-section-71",
]

CASE_TYPE_DESCRIPTIONS: dict[str, str] = {
    "district-commission-complaint-section-35": "Original complaint at District Consumer Forum under CPA 2019 Section 35",
    "state-commission-complaint-section-47": "Original complaint at State Consumer Commission under Section 47",
    "ncdrc-complaint-section-58": "Original complaint at NCDRC under Section 58",
    "medical-negligence-complaint": "Medical-negligence complaint (Jacob Mathew / Bolam standard-of-care framework)",
    "product-liability-action-section-83": "Product-liability action under Section 83 CPA 2019",
    "unfair-trade-practice-complaint": "Unfair-trade-practice complaint under CPA 2019",
    "consumer-appeal-section-41-district-to-state": "Appeal from District Forum to State Commission under Section 41",
    "consumer-appeal-section-51-state-to-ncdrc": "Appeal from State Commission to NCDRC under Section 51",
    "consumer-revisional-application-section-67": "Revisional application under Section 67",
    "consumer-execution-application-section-71": "Execution application under Section 71",
}
...
FULL_ORCHESTRATION_SCRIPT = """# wolfgang_rush — INDIAN CONSUMER FORUMS (DISTRICT / STATE / NCDRC) DRAFTING · FULL ORCHESTRATION SCRIPT
...
district-commission-complaint-section-35, state-commission-complaint-section-47, ncdrc-complaint-section-58, medical-negligence-complaint, product-liability-action-section-83, unfair-trade-practice-complaint, consumer-appeal-section-41-district-to-state, consumer-appeal-section-51-state-to-ncdrc, consumer-revisional-application-section-67, consumer-execution-application-section-71.
...
def get_pleading_base() -> str:
    """Get the shared Consumer drafting base structure."""
