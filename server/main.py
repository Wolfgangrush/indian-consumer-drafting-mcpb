"""Wolfgang Rush — Indian Consumer Forum Drafting MCPB.
...
FULL_ORCHESTRATION_SCRIPT = """# WOLFGANG RUSH — INDIAN CONSUMER FORUMS (DISTRICT / STATE / NCDRC) DRAFTING · FULL ORCHESTRATION SCRIPT
